...
# Create tracker object
    ...
    while True:
        ...
        if y > 220:
            ...
            rgb = bgr[::-1]
            print(rgb)
            cv2.circle(frame, (x1, y) , 4, (255, 0, 0), -1)
            
            if 0 < x < 150:
                x = x/4 + 220
                dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, 250, 73, 100, 50, isQueued = 1)
                dType.dSleep(1000)
                dType.SetPTPCmd(api, dType.PTPMode.PTPMOVLXYZMode, x, 73, 9, 50, isQueued = 1)
                dType.dSleep(2000)
...
while True:
   ...
   for cnt in red_contours:
        ...
        if area > 20000:
            x, y, w, h = cv2.boundingRect(cnt)
            cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 150, 150), 3)
            x = int(x + w/2)
            y = int(y + h/2)
   ...
   cv2.circle(frame, (150, 100) , 4, (255, 0, 0), -1)
   
   cv2.circle(frame, (450, 100) , 4, (255, 0, 0), -1)
